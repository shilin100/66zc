...
#define BACKGROUND_BLACK_COLOR [UIColor clearColor]
...
+ (void)showSinglePickerInView:(UIView *)view
    ...
    [UIView animateWithDuration:0.5 animations:^{
        [UIView animateWithDuration:0.5 animations:^{
            CGRect rect = pickerView.containerView.frame;
            CGFloat pickerViewHeight = pickerView.builder.pickerHeight > CDZToolBarHeight ? pickerView.builder.pickerHeight : CDZPickerViewDefaultHeight;
            rect.origin.y = SCREEN_HEIGHT - pickerViewHeight-64;
            pickerView.containerView.frame = rect;
        }];
    }];
...
+ (CDZPicker*)showLinkagePickerInView:(UIView *)view
                    withBuilder:(CDZPickerBuilder *)builder
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        _confirmButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH -45, 7, 40, 30)];
        ...
        UIColor *color = self.builder.confirmTextColor ?: UIColor.blackColor;
...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        _cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(5, 7, 40, 30)];
        ...
        UIColor *color = self.builder.cancelTextColor ?: UIColor.blackColor;
...
//        _pickerView.backgroundColor = UIColor.clearColor;
        _pickerView.backgroundColor = HEXCOLOR(@"eeeeee");
//        _pickerView.tintColor = MAINGREEN;
