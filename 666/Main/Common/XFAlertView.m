...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        if (message) {
            ...
            self.msgLbl = [self GetAdaptiveLable:CGRectMake(XFSpace, CGRectGetMaxY(self.titleLbl.frame)+XFSpace, AlertW-2*XFSpace, 20) AndText:message andIsTitle:NO];
        ...
        self.lineView.frame = self.msgLbl?CGRectMake(0, CGRectGetMaxY(self.msgLbl.frame)+2*XFSpace, AlertW, 1):CGRectMake(0, CGRectGetMaxY(self.titleLbl.frame)+2*XFSpace, AlertW, 1);
